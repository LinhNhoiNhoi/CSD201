...
//remove
    ...
    Node max() {
        ...
        while (p != null) {
            if (p.infor.mark > maxNode.infor.mark) {
                maxNode = p;
            }
            p = p.next;
        }
...
// xem lại code n sai vơi th phần tử giống nhau
    Node secondMax() {
        ...
        Node p = head;
        while (p != null) {
            if (maxNode == null || p.infor.mark > maxNode.infor.mark) {
                secondMaxNode = maxNode;
                maxNode = p;
            } else if (secondMaxNode == null || p.infor.mark > secondMaxNode.infor.mark) {
                if (p != maxNode) {
                    secondMaxNode = p;
                }
            }
    ...
    void bubbleSort() {
        ...
        do {
            ...
            while (current != null && current.next != null) {
                if (current.infor.mark > current.next.infor.mark) {
    ...
    Student searchBySid(String sid) {
        Node p = head;
        while (p != null) {
            if (p.infor.sid.equals(sid)) {
                return p.infor; // Return the student if found
            }
            p = p.next;
        }
    ...
    Student searchByMark(double mark) {
        Node p = head;
        while (p != null) {
            if (p.infor.mark == mark) {
                return p.infor; // Return the student if found
            }
            p = p.next;
        }
